 ...
 */
#if 0
static int md5_file( char *path, unsigned char output[16] )
{
    FILE *f;
    size_t n;
    md5_context ctx;
 ...
 */
static void md5_csum( unsigned char *input, int ilen,
 ...
 */
#if 0
static void md5_hmac( unsigned char *key, int keylen,
