...
int send_file(const void *buff, const unsigned int size);//zjc
int myread(void * buff,const unsigned int size,const unsigned int msec);
...
unsigned char __calc_check_sum(unsigned char *data, const unsigned int len);
