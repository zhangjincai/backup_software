 ...
 * 获取通用库最后修改时间
 */
 char *lib_general_last_modify_datetime(void);
...
int lib_serial_send_select(lib_serial_t *sel, unsigned char *pdata, const int size, const unsigned int msec);
int lib_serial_recv_select(lib_serial_t *sel, unsigned char *pdata, const unsigned int msec);
int lib_serial_send(lib_serial_t *sel, unsigned char *pdata, const int size);
int lib_serial_recv(lib_serial_t *sel, unsigned char *pdata);
...
int lib_readn(int fd, void *pdata, const unsigned int nbytes);
int lib_writen(int fd, void *pdata, const unsigned int nbytes);
...
int lib_ringbuffer_put(lib_ringbuffer_t *rb, const unsigned char *ptr, unsigned int len);
...
int lib_ringbuffer_putforce(lib_ringbuffer_t *rb, const unsigned char *ptr, unsigned int len);
...
int lib_get_net_info(char *ifname, lib_net_info_t *cfg);
in_addr_t lib_get_ifnetmask(const char *ifname);
in_addr_t lib_get_ifdns(void);
in_addr_t lib_get_ifgateway(void);
...
int lib_set_gateway(in_addr_t gate); 
...
int lib_tcp_read(int sockfd, void *buf, const unsigned int len);
int lib_tcp_write(int sockfd, const void *buf, const unsigned int len);

int lib_tcp_readn(int sockfd, void *buf, const unsigned int len);
int lib_tcp_writen(int sockfd, const void *buf, const unsigned int len);
